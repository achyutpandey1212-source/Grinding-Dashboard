...
// getUser("ash", function(details){
//     getUserPosts(details.id,function(data){
//         console.log(details.userName, data);
//     } );
// })
...
// loginUser({id: 1, name: "Ash"}, function(detail){
//     fetchPermissions(detail.id, function(permission){
//         loadDashboard(permission, function(status){
//             console.log(status);
//         })
//     })
// })